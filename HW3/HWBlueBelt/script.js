...
let currency;
confirm('You want to seee all currencys')? shoeCurencys() : currency = prompt('enter currency for exchange (usd, eur, rub...etc)') ;
...
fetch(url)
    .then(res => res.json())
    .then(data => {console.log(data.rates.UAH)
